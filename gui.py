...
def important_frames():
  ...
  for i, filename in enumerate(image_files, start=1):
    ...
    prompt = "caption this image, dont give any extra output like Here's a caption summarizing the image"
...
if __name__ == "__main__":
    ...
    process1 = multiprocessing.Process(target=capture_frames, args=("video2.mp4",))

    # Use a thread for I/O-bound API calls
    thread2 = threading.Thread(target=extract_audio, args=("video2.mp4", "audio.mp3"))
    ...
    # Generate the PDF after both tasks finish
    make_pdf()
